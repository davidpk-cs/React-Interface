...
class HomeApp extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
            freezerTemp: Number(localStorage.getItem('freezerTemp')) || defaultFreezerTemp,
            freezerUnit: localStorage.getItem('freezerUnit') || defaultFreezerUnit,
            fridgeTemp: Number(localStorage.getItem('fridgeTemp')) || defaultFridgeTemp,
            fridgeUnit: localStorage.getItem('fridgeUnit') || defaultFridgeUnit,
          };
        this.saveFridgeData.bind(this);
