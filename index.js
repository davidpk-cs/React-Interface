...
class HomeApp extends React.Component{
    ...
    constructor(props){
        ...
        if (savedState) {
            ...
            // Initialize the state if no saved state is found
    ...
    removeCity = () => {
        ...
        try {
        this.setState({
            cities: this.state.cities.filter(item => item.city !== cityName)
        }, ()=> (this.setHomepageWeather()));
        } catch(e) {
            console.log('error');
        }
                ...
                <div id = "homePage">
                    ...
                    <div id = "homePanelManager">
                        ...
                        <div class = "homePanel" onClick = { () => this.setState( {page: "Temp"})}>
                            ...
                            <div class = "homePanelDisplay">
                                <p class = "homePanelDisplayText">Click to Enter</p>
            ...
            if(this.state.tempSch){
                sched = (<div className = "row justify-content-evenly">
                                <div className = "col-7 room ">
                                    ...
                                    <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Living")}>Clear Schedule</button>
                                    <br></br><br></br>
                                    <h4>Dining Room</h4>
                                    {dining}
                                    ...
                                    <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Dining")}>Clear Schedule</button>
                                    <br></br><br></br>
                                    <h4>Top Floor</h4>
                                    {top}
                                    ...
                                    <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Top")}>Clear Schedule</button>
                                    <br></br><br></br>
                                    <h4>Basement</h4>
                                    {basement}
                                    ...
                                    <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Basement")}>Clear Schedule</button>
                                </div>
                            </div>);
            }else{
                sched = <div></div>
            ...
            let sched, vac, coffee;
                ...
                if(this.state.devSch){
                    sched = (<div className = "row justify-content-evenly">
                                        ...
                                        <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Vac")}>Clear Schedule</button>
                                        <br></br><br></br>
                                        <h4>Coffee Maker</h4>
                                        {coffee}
                                        <p>Set active interval:</p>
                                        ...
                                        <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Coffee")}>Clear Schedule</button>
                                </div>
                            </div>);
                        }
            return (
                <div>
                    ...
                    <h3 class = "homePanelTitle">Coffeemaker</h3>
                        ...
                        <div class="slidecontainer">
                            <input type="range" min="1" max="100" value={this.state.sliderValue} class="slider" onChange={(e) => this.setState({sliderValue: e.target.value})} id="myRange"></input>
                        </div>
                    </div>
                    </div>
                     ...
                     <div id = "homePanelManager">
                        ...
                        <h3 class = "homePanelTitle">Add City</h3>
                            ...
                            <button className="btn btn-danger btn-lg m-1"
                                onClick={() => {this.removeCity(this.state.cities, "anyCity")}}>Remove City</button>                     
                        </div>
                        </div>
                ...
                if(this.state.gardenSch){
                    sched = (<div className = "row justify-content-evenly">
                                        ...
                                        <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Lights")}>Clear Schedule</button>
                                        <br></br><br></br>
                                        <h4>Irrigation</h4>
                                        {irrigation}
                                        <p>Set active interval:</p>
                                        ...
                                        <button className = "btn-sm bttn-cancel" onClick = {() =>this.clearSched("Irr")}>Clear Schedule</button>
                                </div>
                            </div>);
                        }
    ...
    setSched(panel){
        if(panel === "Living"){
            ...
            this.setState({basementDisp6: this.state.basementSchUnit});
    ...
    clearSched(panel){
        if(panel === "Living"){
            this.setState({livingSch: false});
        }else if(panel === "Dining"){
            this.setState({diningSch: false});
        }else if(panel === "Top"){
            this.setState({topSch: false});
        }else if(panel === "Basement"){
            this.setState({basementSch: false});
        }else if(panel === "Lights"){
            this.setState({garLightsSch: false});
        }else if(panel === "Irr"){
            this.setState({garIrrSch: false});
        }else if(panel === "Vac"){
            this.setState({vacSch: false});
        }else if(panel === "Coffee"){
            this.setState({coffeeSch: false});
        }
    }
